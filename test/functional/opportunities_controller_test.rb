...
class OpportunitiesControllerTest < ActionController::TestCase
  ...
  test "should create opportunity" do
    assert_difference('Opportunity.count') do
      post :create, opportunity: { company_id: @opportunity.company_id, suggestion: @opportunity.suggestion, task: @opportunity.task, user_id: @opportunity.user_id }
    end
  ...
  test "should update opportunity" do
    put :update, id: @opportunity, opportunity: { company_id: @opportunity.company_id, suggestion: @opportunity.suggestion, task: @opportunity.task, user_id: @opportunity.user_id }
    assert_redirected_to opportunity_path(assigns(:opportunity))
  end
